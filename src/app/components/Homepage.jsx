...
function Homepage(){
    return (
        ...
        <nav style={styles.navbar}>
          <div style={styles.navbarBrand}>ChatBot Sugarcane</div>
          <ul style={styles.navbarList}>
            <li style={styles.navbarItem}><a href="#introduction" style={styles.navbarLink}>Introduction</a></li>
            <li style={styles.navbarItem}><a href="#news" style={styles.navbarLink}>News</a></li>
            <li style={styles.navbarItem}><a href="#about" style={styles.navbarLink}>About</a></li>
            <li style={styles.navbarItem}><a href="#contact" style={styles.navbarLink}>Contact</a></li>
          </ul>
          <button style={styles.loginButton}>Login</button>
        </nav>
  
        <section id="introduction" style={styles.introductionSection}>
          <h1 style={styles.introductionHeading}>Welcome to Sugarcane – Your Friendly, AI-powered Chatbot!</h1>
